...
$sql ="UPDATE `propietario` SET `nom_propietario` = '$nom_propietario', `direccion`= '$direccion',`telefono`= '$telefono'  WHERE `no_INE` = '$no_INE'";
...
function Redirect()
{
window.location="actualizarCliente.html";
}
